...
private:
	inline static loading<sf::Texture> logo{ FileLoader::Instance().addTextureToUpload("img/icons/logo.png").get() };
	inline static loading<sf::SoundBuffer> sound_track_buff{
		FileLoader::Instance().addSoundToUpload("assets/darkfall.wav").get()
	};
